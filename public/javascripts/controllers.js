...
if(localStorage.getItem('admin') == null){
    ...
    /*$scope.pickDate = function(model) {
     $scope.datePick = model;
     //$scope.d = new Date(model);
     $scope.d = model.substring(0,12);
     $scope.searchQuery =  $scope.d.getDate() + $scope.d.getMonth() + $scope.d.getFullYear();
     alert($scope.d );
     }*/
